...
class _ApplyLeaveScreenState extends State<ApplyLeaveScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Apply Leave", style: TextStyle(color: AppColors.whiteColor)),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  isDropdown: true,
                  dropdownItems: ["Sick Leave", "Casual Leave", "Annual Leave"],
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text("Apply Leave", style: TextStyle(fontSize: 16 , color: AppColors.whiteColor)),
                  ),
                ),
                const SizedBox(height: 20),
              ],
